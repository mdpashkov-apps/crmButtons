...
$eventBind = overCRest::call(
    ...
    [
        ...
        'handler' => 'https://app.overplan.ru/applications/crmButtons/3/uninstall.php'
    ]
);
...
function registerReport() {
    ...
    $getChat = overCRest::call("im.search.chat.list", [
			"FIND" => CHAT_REPORT
    ])['result'];

    $getBot = overCRest::call("imbot.bot.list", [
    ])['result'];      
	...
	if($getChat == NULL || count($getChat) == 0) {
