...
// Смарт-процессы
    ...
    $batchSP = [
        ...
        // //Доработка по новым счетам
        // array_push($newObject['array_entities'], ["value" => 31, "name" => "Новые счета"]);

        // $qwerty = overCRest::call('crm.enum.ownertype', [])['result'];
        file_put_contents(__DIR__.'/check_entities.log', var_export($newObject['array_entities'], 1), FILE_APPEND);
...
if ($entityFields == 'crm.type.fields') {
