const api = axios.create({
  baseURL: `https://app.overplan.ru/applications/crmButtons/${window.versions}/buttonHandlers`,
});
...
export const getLinkValueFilds = async (
  memberId,
  idFieldsLink,
  idEntity,
  entityType,
) => {
  const responseGetLink = await api.post("/getLinkFields.php", {
    memberId: memberId,
    idFieldsLink: idFieldsLink,
    idEntity: idEntity,
    entityType: entityType,
  });
  return responseGetLink.data;
};
...
export const addListElement = async (
  id,
  idEntity,
  entity,
  fieldsList,
