...
<div id="app">
    ...
    <div class="content" v-if="current_button && current_button.button_actions">
        <div class="settings_fields">
            ...
            <h3>Действие кнопки {{current_button.button_actions.business_processes.value}}</h3>
            ...
            <div class="panel" :class="{panel_show:accordion_0}" v-if='flagsButtonBizproc'>
                <div class="div_row">
                    <label for="activate_the_property_0">Активировать свойство: {{current_button.button_actions.business_processes.options}}</label>
                    <div>
