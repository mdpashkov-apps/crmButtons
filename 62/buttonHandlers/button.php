...
<body>	
	...
	<div id="app">
		...
		<button v-if="businessProcessWithParameters.length == 0" class="btn" :style="styleObject" @click="performAnAction">
			<!-- <span v-if="buttonFields.usingTheIcon_FIELDS"> -->
				<span v-if="buttonFields.usingTheIcon_FIELDS === 'true'">
    ...
    <script>
const requstOptions = <?print_r($_REQUEST['PLACEMENT_OPTIONS'])?>;
const idEntity = requstOptions.ENTITY_VALUE_ID;
window.entityValueId = idEntity;
    </script>
