const api = axios.create({
    baseURL: `https://app.overplan.ru/applications/crmButtons/${window.versions}/applicationHandlers`,
});
...
export const getBiznprocesByEntity = async (memberId, entityType) => {
    return await api.post("/getBiznprocByEntity.php", {
        memberId: memberId,
        entityType: entityType,
    });
};

export const getDocumentTemplateByEntity = async (memberId, entityType) => {
    return await api.post("/getDocumentTemplateByEntity.php", {
        memberId: memberId,
        entityType: entityType,
    });
};

export const getCrmLinkFiledsByEntity = async (memberId, entityType) => {
    return await api.post("/getCrmLinkFields.php", {
        memberId: memberId,
        entityType: entityType,
    });
};
export const getListByEnity = async (memberId, entityType) => {
    return await api.post("/getListByEntity.php", {
        memberId: memberId,
        entityType: entityType,
    });
};
